                ...
                <form:form method="POST" modelAttribute="colour" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-3 control-lable" for="cldescr">Description</label>
                            <div class="col-md-7">
                                <form:input type="text" path="cldescr" id="cldescr" class="form-control input-sm"/>
                                <div class="has-error">
                                    <form:errors path="cldescr" class="help-inline"/>
                                </div>
                            </div>
                        </div>
                    </div>
