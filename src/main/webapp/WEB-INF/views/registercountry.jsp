                ...
                <form:form method="POST" modelAttribute="country" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-3 control-lable" for="cdescr">Description</label>
                            <div class="col-md-7">
                                <form:input type="text" path="cdescr" id="cdescr" class="form-control input-sm"/>
                                <div class="has-error">
                                    <form:errors path="cdescr" class="help-inline"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-bottom: 20px; display:flex; justify-content: center;">
                        <div class="form-actions floatRight">
                            <c:choose>
                                <c:when test="${edit}">
                                    <input type="submit" id="myAdd" value="Update" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/admin' />">Cancel</a>
                                </c:when>
                                <c:otherwise>
                                    <input type="submit" id="myAdd" value="Register" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/admin' />">Cancel</a>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
